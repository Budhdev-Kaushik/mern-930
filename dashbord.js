...
axios("https://6235ab6a163bf7c4745d3176.mockapi.io/products").then((res) => {
  if (res.status == 200) {
...
function deleteProduct(e, id) {
  ...
  let input = confirm("Do you want to delete this Product");
  if (input) {
    axios
      .delete(`https://6235ab6a163bf7c4745d3176.mockapi.io/products/${id}`)
      .then((res) => {
        if (res.status === 200) {
